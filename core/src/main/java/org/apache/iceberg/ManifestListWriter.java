...
abstract class ManifestListWriter implements FileAppender<ManifestFile> {
  ...
  private StandardEncryptionManager.ManifestListKeys lazyManifestListKeys = null;
  ...
  public ManifestListFile toManifestListFile() {
    if (manifestListKeyMetadata != null && manifestListKeyMetadata.encryptionKey() != null) {
      // Generate once so repeated calls return the same key id.
      if (lazyManifestListKeys == null) {
        this.lazyManifestListKeys =
            standardEncryptionManager.generateManifestListKey(
  ...
  /** Keys generated while writing this manifest list, or {@code null} if unencrypted. */
  public StandardEncryptionManager.ManifestListKeys manifestListKeys() {
